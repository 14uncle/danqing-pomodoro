...
pub const SCENES: [SceneSpec; 9] = [
    SceneSpec {
        ...
        palette: ScenePalette {
            ...
            backdrop_light: Color::from_srgb8(120, 130, 140),
    ...
    SceneSpec {
        ...
        palette: ScenePalette {
            ...
            surface: Color::rgba(0.0, 0.0, 0.0, 0.25),
            surface_input: Color::rgba(0.0, 0.0, 0.0, 0.38),
            backdrop_light: Color::from_srgb8(100, 120, 130),
    ...
    SceneSpec {
        ...
        palette: ScenePalette {
            ...
            surface: Color::rgba(0.0, 0.0, 0.0, 0.25),
            surface_input: Color::rgba(0.0, 0.0, 0.0, 0.38),
            backdrop_light: Color::from_srgb8(110, 125, 130),
    ...
    SceneSpec {
        ...
        palette: ScenePalette {
            ...
            surface: Color::rgba(0.0, 0.0, 0.0, 0.25),
            surface_input: Color::rgba(0.0, 0.0, 0.0, 0.38),
            backdrop_light: Color::from_srgb8(160, 120, 137),
    ...
    SceneSpec {
        ...
        palette: ScenePalette {
            ...
            surface: Color::rgba(0.0, 0.0, 0.0, 0.25),
            surface_input: Color::rgba(0.0, 0.0, 0.0, 0.38),
            backdrop_light: Color::from_srgb8(90, 120, 110),
    ...
    SceneSpec {
        ...
        palette: ScenePalette {
            ...
            surface: Color::rgba(0.0, 0.0, 0.0, 0.25),
            surface_input: Color::rgba(0.0, 0.0, 0.0, 0.38),
            backdrop_light: Color::from_srgb8(146, 136, 92),
    ...
    SceneSpec {
        ...
        palette: ScenePalette {
            ...
            surface: Color::rgba(0.0, 0.0, 0.0, 0.25),
            surface_input: Color::rgba(0.0, 0.0, 0.0, 0.38),
            backdrop_light: Color::from_srgb8(130, 137, 133),
    ...
    SceneSpec {
        ...
        palette: ScenePalette {
            ...
            surface: Color::rgba(0.0, 0.0, 0.0, 0.25),
            surface_input: Color::rgba(0.0, 0.0, 0.0, 0.38),
            backdrop_light: Color::from_srgb8(140, 140, 140),
    ...
    SceneSpec {
        ...
        palette: ScenePalette {
            ...
            surface: Color::rgba(0.0, 0.0, 0.0, 0.25),
            surface_input: Color::rgba(0.0, 0.0, 0.0, 0.38),
            backdrop_light: Color::from_srgb8(140, 133, 116),
