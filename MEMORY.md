...
- [双轨应用内更新感知](docs/intent/update-check.md) — 商店轨 StoreContext 应用内拉更新 / GitHub 轨静默查 Releases 告知+跳发布页; store feature 编译时隔离轨道; 设置页版本行+设置按钮角标; 2026-09-05 落地并双轨实测通过 (spec: docs/specs/update-check.md); 2026-09-08 核心+GitHub 轨下沉 danqing::update (框架 update feature), 产品只留轨道分派+商店轨
