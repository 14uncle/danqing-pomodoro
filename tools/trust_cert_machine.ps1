...
# 前提: 已跑过 tools/sign_msix_local.ps1 (生成了 ..\release-archives\pomodoro\msix\sideload-signing.pfx)
# 用法 (触发 UAC 提权):
...
# 提权窗口一闪而过看不到结果: 落一份日志 + 结束暂停
$LogPath = Join-Path $RepoRoot "..\release-archives\pomodoro\msix\trust-cert.log"
